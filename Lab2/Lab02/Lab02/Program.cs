...
public class Dsm
{
    ...
    {
        Console.WriteLine($"Z = {_zFinalValue}");
        Console.Write("Y* = (");
        var isPrinted = false;
    ...
    private void PrintTable()
    {
        ...
        _tableBrakingLine = "";
        for (var i = 0; i < 3 + _ySystemColumnCount - 1; i++)
        {
        ...
        for(var i = 0; i < 4+_ySystemColumnCount-1; i++)
            _tableBrakingLine += "-";
    ...
    private void PrintDataForDsm(string str)
    {
        ...
        switch (str)
        {
            case "base":
                ...
                break;
            case "canonical":
                Console.WriteLine("-----------------------Canonical Data for Dual Simplex Method -----------------------");
                break;
        }
        PrintYSystem();
        PrintZ();
