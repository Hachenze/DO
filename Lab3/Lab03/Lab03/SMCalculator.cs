...
public class SMCalculator
{
    ...
    {
        return SystemPartsAmount;
    }

    public int GetCountOfAdditionalVars()
    {
        return AmountOfBasisVariables;
    }
    public int GetCountOfFreeVars()
    {
        return AmountOfFreeVariables;
    }

    public int GetTableColumnCount()
    {
        return AmountOfBasisVariables + AmountOfFreeVariables;
    }
    public double[] GetGoalFunctionCoefs()
    {
        return _goalFunctionCoefs;
    }
